# ADVANCE AUTH para express.js
[![Build Status](https://travis-ci.com/ismaelalvesgit/node-express-advance-auth.svg?branch=master)](https://travis-ci.com/ismaelalvesgit/node-express-advance-auth)
